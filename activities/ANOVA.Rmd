...
The mean SAT score increases as the university type gets more rigorous (community -> public -> private). The same goes for the media SAT score. The opposite occurs with the standard deviation, suggesting that the level of education is correlated with lenience of admissions decisions. I also thought it was interestign that both public and private universities had a maximum score of 1600.
...
Private and community colleges hold the biggest difference, and public and private colleges have the smallest difference, though it's still very significant. In the middle, public and community college SAT scores also differ from each other.

3. How large are these differences?
Private vs. Community: 366.96 points
* Public vs. Community: 292.55
* Private vs. Public: 74.40 points
...
SAT scores greatly differ among college types

SAT scores, which are meant to predict success in higher education, greatly vary between college types. Private universities hold the highest mean SAT score, followed by public institutions and community colleges respectively.
