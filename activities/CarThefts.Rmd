...
The data is skewed towards the right. Most of the data is within one standard deviation above the mean while significantly less data points are within one standard deviation below the mean.
