...
Yes because it shows statistical significance on a variety of levels and helps us differentiate and analyze data between multiple variables. It helps determine whetehr certain variables are significant or not and if that controbutes to an overall significance of the data.
...
Points scored has the greatest impact on wins whereas Yards Gained is the least impactful. Takeaways falls somewhere in the middle.
...
I would explain how the data was found by comparing various independent variables to the dependent variable. In this context, I would write something along the lines of "Points scored was the most likely predictor of a win compared to yards gained or takeaways, according to a data analysis of the variables."
