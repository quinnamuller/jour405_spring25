...
Yes there is some variation between the expected adn observed data. There are much more 2-star rated movies in the observed data and somewhat fewer 5-star and 3-star movies observed than expected.
...
The chi-square statistic is greater than the critical value, so we would reject the null hypothesis. This means that the observed data is statistically different from the expected data.
