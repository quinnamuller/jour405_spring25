...
The means and standard distributions are somewhat similar when comparing the sample sizes of 50 and 100, but when you decrease the sample size to 10, the results start veering form accuracy.
