...
The people who voted that they rarely/never vote had the biggest differences in both Yes and No categories.

2. How might these differences affect reporting on likely voter turnout?

It shows that the weighting does not necessarily accurately portray the voting populations. It could make reporters miss that more people are turning out to vote and underestimate overall voter turnout.
...
These differences exist to more accurately represent the opinions of the overall population. It shows that people who don't vote as often or can't vote as often, like low-income individuals, young people, and the elderly are making more of an effort to vote.
