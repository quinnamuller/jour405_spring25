---
title: "HW13_CollegeLetterGrades"
...
Sample Size: The total number of students in the sample (400)
...
I think that the difference in students who got As is probably significant and maybe also those who got Cs, but the rest of the differences in the data don't seem super significant. The differences are greater for As and Cs and they aren't very big for the other grade categories.
...
Yes, because the chi-square statistic is 11.67 and the critical value is 9.49. If we reject the null hypothesis, that means that we reject the expected frequencies.
...
For As and Cs, and maybe even Fs there are some notable differences, which goes to support the rejection of the null hypothesis. I would ask if there was a curve. I would also ask why the percentage for Bs and Cs is the same. What stands out to me is the fact hat the observed results for As and Cs are the same but the percentage assigned is different, so I would also ask about that.
