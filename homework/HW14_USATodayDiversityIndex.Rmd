---
title: "HW14_USATodayDiversityIndex"
...
Adelphi, Beltsville, Calverton and Glenmont seem like they would be diverse and have high diversity ratings.
...
Summerfield has the highest race probability because there are very, very low numbers of poulations that are not Black. The Black population is 93% of the city.
...
Chillum has the lowest Hisp_Prob score, which is still pretty high at 50-ish%. Many of these cities with lower probabilities had pretty low race probabilities and didn't seem as dominated by one race.
...
The top three most diverse cities are Langley Park, Wheaton, and Adelphi. They're all located in Maryland's DC suburbs, as are many of the other highly diverse cities which fall in Montgomery and Prince George's counties. Interestingly enough, two of the three least diverse areas in Maryland are also in Prince George's County, while the least diverse city, Lake Shore, MD, is in Anne Arundel County. 
...
Prince George's County is one of the most and least diverse MD counties

While some cities like Langley Park and Adelphi top the list of diverse Maryland cities, others like Largo and Lake Arbor fall to the bottom of it.

I would talk to residents to see their perspective on the diversity of their neighborhoods and cities. I would probably look into factors that vary often with race-dominated cities and see if the diversity or lack thereof is having an impact. To do so I would look at more data but also talk to local politicians, school administrators and local business owners. I would definitely go about describing it similarly to USA Today.
