...
```{r}
june_change <- pg_crime_averages %>% mutate((average-Jun)/average*100)
july_change <- june_change %>% mutate((average-Jul)/average*100)
august_change <- july_change %>% mutate((average-Aug)/average*100)
summer_crime_averages <- august_change

#Did I use the right base or is the data for each month suppose to be the base instead fo the average?
```
